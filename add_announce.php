...
<?php include("nav_announcer.php"); ?>
    ...
    <form action="insert_announce.php" method="POST">
        <div class="mx-auto m-24 w-2/6 p-6 shadow-2xl rounded-lg">
            ...
            <a href="index.php" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2 text-center inline-block dark:hover:bg-blue-700">
                Back
            </a>
