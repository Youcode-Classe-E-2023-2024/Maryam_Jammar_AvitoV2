...
<body>
    ...
    <form action="update_user.php" method="POST" class="max-w-md mx-auto bg-gray-100 p-8 rounded-lg m-12">
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <select name="id_role" id="id_role" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="<?php echo $id_role; ?>" required>
